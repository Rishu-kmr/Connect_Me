...
class _EditProfileState extends State<EditProfile> {
      ...
      children: <Widget>[
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: "Update Dispaly Name",
            errorText: _displayNameValid ? null : "dispaly name too short",
          ),
        ),
      ],
    );
  ...
  updateProfileData(){
    setState(() {
      ...
      bioController.text.trim().length > 50 || bioController.text.isEmpty ? _bioValid = false : _bioValid = true;
    });
