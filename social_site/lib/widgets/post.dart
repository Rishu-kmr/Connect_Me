...
class Post extends StatefulWidget {
  ...
  int getLikeCount(likes){
    ...
    int count = 0;
    // if the key is explicitly set to true increase count
  ...
  _PostState createState() => _PostState(
    ...
    likes: this.likes,
    likeCount: getLikeCount(this.likes)     // check for error here
  );
}
...
class _PostState extends State<Post> {
  ...
  buildPostImage(){
    return GestureDetector(
      onDoubleTap: () => print("liking posts"),
      child: Stack(
